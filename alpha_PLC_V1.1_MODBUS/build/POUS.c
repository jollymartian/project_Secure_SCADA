...
void APLHA_init__(APLHA *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->MANUAL_1,__BOOL_LITERAL(FALSE),retain)
  __INIT_VAR(data__->MANUAL_2,__BOOL_LITERAL(FALSE),retain)
...
void APLHA_body__(APLHA *data__) {
  ...
  __SET_VAR(data__->,PWR_PLANT,,(__GET_VAR(data__->MANUAL_2,) && (!(__GET_VAR(data__->MANUAL_1,)) || __GET_VAR(data__->PWR_PLANT,))));
