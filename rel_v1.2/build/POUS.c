...
void APLHA_init__(APLHA *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->ANTENNA,__BOOL_LITERAL(FALSE),retain)
...
void APLHA_body__(APLHA *data__) {
  ...
  __SET_VAR(data__->,PWR_PLANT,,(__GET_VAR(data__->THRESHOLD_MIN_OUTPUT_PWR,) && !(__GET_VAR(data__->PWR_PLANT_SWITCH,))));
  __SET_VAR(data__->,PWR_GEN,,(__GET_VAR(data__->THRESHOLD_MIN_OUTPUT_GEN,) && !(__GET_VAR(data__->PWR_PLANT,))));
  __SET_VAR(data__->,PWR_BUILDINGS_ON,,__GET_VAR(data__->PWR_PLANT,));
  __SET_VAR(data__->,ANTENNA,,__GET_VAR(data__->PWR_PLANT,));
  __SET_VAR(data__->,PWR_BUILDINGS_OFF,,!(__GET_VAR(data__->PWR_PLANT,)));
  __SET_VAR(data__->,VAPE_START,,!(__GET_VAR(data__->PWR_PLANT,)));
  __SET_VAR(data__->TP_WITH_RESET0.,IN,,(!(__GET_VAR(data__->VAPE_RESET,)) && (__GET_VAR(data__->PWR_GEN,) || __GET_VAR(data__->VAPE_START,))));
  ...
  __SET_VAR(data__->,PWR_HOSPITAL_ON,,((__GET_VAR(data__->THRESHOLD_MIN_OUTPUT_GEN,) && __GET_VAR(data__->PWR_GEN,)) || __GET_VAR(data__->PWR_PLANT,)));
